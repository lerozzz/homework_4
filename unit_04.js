...
function f4() {
    let cb4 = document.querySelector('.i-4');
    let result;
    if (cb4.checked) {
        result = 'Нажат';
    }
...
function f5() {
    let cb5 = document.querySelector('.i-5');
    let result;
    if (cb5.checked) {
        result = cb5.value;
    }
...
function f6() {
    let cb6 = document.querySelector('.i-6');
    document.querySelector('.out-6').innerHTML = cb6.value;
}
...
function f7() {
    let cb7 = document.querySelector('.i-7');
    document.querySelector('.out-71').innerHTML = cb7.value;
    let result;
    if (cb7.value.length >= 6) {
        result = "1";
    }
    else {
        result = "0";
    }
    document.querySelector('.out-72').innerHTML = result;
}
...
function f8() {
    ...
    // т.е. как строку и вставляем на страницу
    //  потом получаем кнопку со страницы и вешаем событие
    //    вашасозданнаякнопка.onclick = f81;
    let buttonWrapper = document.querySelector('.out-8');
    buttonWrapper.innerHTML = '<input type="text" class="i-81"><button class="b-81">Task-81</button>';
...
function f10() {
    ...
    document.querySelector('.out-10').style.backgroundColor = b10.value;
}
...
function f12() {
    ...
    document.querySelector('.out-12').innerHTML = i12.value;
}
...
function f15() {
    ...
    document.querySelector('.t-15').value = i15.value;
}
...
function f19() {
    ...
    document.querySelector('.out-19').innerHTML = i191.value + ' ' + i192.value;
}
...
function f20(e) {
    ...
    let elem1 = form.elements.password.value;
    let elem2 = form.elements['username'].value;
    document.querySelector('.out-20').innerHTML = elem2 + ' ' + elem1;
}
